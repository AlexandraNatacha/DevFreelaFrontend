...
function createOrEdit() {
    ...
    // Enviar para API
    fetch(`https://64d2376af8d60b174361aa4b.mockapi.io/api/projects${screenType === 'edit' ? ('/' + params.id) : ''}`, {
...
function fillInputs() {
    if (screenType == 'edit') {
        fetch(`https://64d2376af8d60b174361aa4b.mockapi.io/api/projects/${params.id}`)
            .then(response => response.json())
            .then(project => {
